 ...
 *
 * @author ☪wl
 * @date 2021-04-24 20:30
 */
public class NickNameUtils {

    public static String randomName(int len) {
        String[] surName = {
                "卫", "尤", "金", "水", "云", "郎", "花", "乐", "于", "毛", "贝", "明", "成", "危", "江", "童", "颜", "刁", "丘",
                "田", "万", "支", "干", "应", "丁", "单", "包", "左", "石", "羊", "家", "井", "巫", "乌", "焦", "巴", "弓", "山",
                "谷", "车", "全", "伊", "暴", "甘", "斜", "厉", "戎", "祖", "武", "符", "景", "束", "龙", "叶", "幸", "司", "印",
                "宿", "白", "怀", "从", "卓", "屠", "蒙", "池", "乔", "能", "苍", "双", "贡", "劳", "逄", "姬", "申", "扶", "堵",
                "冉", "牛", "寿", "通", "边", "燕", "尚", "农", "别", "阎", "充", "连", "习", "艾", "鱼", "容", "向", "古", "易",
                "戈", "庾", "终", "步", "都", "耿", "弘", "匡", "文", "东", "利", "蔚", "师", "巩", "勾", "敖", "那", "空", "后",
                "红", "游", "盖", "有", "牟", "哈", "爱", "阳", "大", "上", "下", "冷", "暖", "春", "夏", "秋", "冬", "狗", "猫",
                "猪", "小", "小", "小", "小", "小", "小", "小", "小", "小", "小", "老", "老", "老", "老", "老", "老", "老", "老",
                "老", "老"
        };
